# Vehicle Management System using OOP in Python
# Demonstration of abstraction, inheritance, and method overriding.
...
class Car(Vehicle):
    ...
    def calculate_fuel_efficiency(self):
        return "Car fuel efficiency: 25 MPG."
...
class Motorcycle(Vehicle):
    ...
    def calculate_fuel_efficiency(self):
        return "Motorcycle fuel efficiency: 50 MPG."
    ...
    def get_details(self):
        sidecar = "Yes" if self.__has_sidecar else "No"
        return f"Motorcycle: {self.brand} {self.model}, Sidecar: {sidecar}"
...
if __name__ == "__main__":
    ...
    for v in vehicles:
        ...
        print(v.calculate_fuel_efficiency())
        print(v.get_details())
        print(v.stop_engine())
        print()
